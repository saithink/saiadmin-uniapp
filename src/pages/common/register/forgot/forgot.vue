<template>
    <view class="account-container">
        ...
        <form :report-submit="true" @submit="formReset">
            <view class="login-from" v-if="!checkEmail">
...
import { emailResetApi, sendForgotEmailApi, captchaApi } from '@/api/common/index.js'
